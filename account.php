...
<title>MCQ Test Taking Platform</title>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Saquib Usman</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Saquib Pvt Ltd</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Saquib Pvt Ltd</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9514444471</h4>
		<h4 style="font-family:'typo' ">saquib@gmail.com</h4>
		<h4 style="font-family:'typo' ">AMC Engineering College </h4></div></div>
		</p>
      </div>
